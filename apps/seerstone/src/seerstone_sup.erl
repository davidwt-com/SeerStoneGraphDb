...
%% Description: seerstone_sup is the template for the
%%				supervisor callback module for the erlang supervisor behavior.
%%  
...
%% Start Supervisors (eg. SUP1, SUP2,....)
	...
	SupFlags = {Restart_Strategy, MaxR, MaxT},
	%% No children: nref and database are peer OTP applications started
	%% by application_master in dependency order from seerstone.app.src's
	%% `applications:` list. seerstone_sup is reserved for future
